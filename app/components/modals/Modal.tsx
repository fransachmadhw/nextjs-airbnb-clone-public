      ...
      <div className="flex justify-center items-center xl:items-start 2xl:items-center overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none bg-neutral-800/70">
        <div className="relative w-full md:w-4/6 lg:w-3/6 xl:w-2/5 my-6 mx-auto h-full md:h-auto lg:h-auto">
          ...
          <div
            ...
            `}
          >
            <div className="translate h-full lg:h-auto md:h-auto border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none xl:my-10 2xl:my-0">
              {/* Header */}
              <div className="flex items-center p-6 rounded-t justify-center relative border-b-[1px]">
                <div className="relative w-full bg-transparent flex items-center justify-center">
                  <button
                    onClick={handleClose}
                    className="p-0 border-0 hover:opacity-70 transition absolute left-0"
                  >
                    <IoMdClose size={18} />
                  </button>
